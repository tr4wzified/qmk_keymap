...
/*   [TD_WINDOW]  = ACTION_TAP_DANCE_DOUBLE(KC_LGUI, MO(_WINDOW)) */
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | OS   | ALT  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,  DVORAK,  PLOVER,  OSL(_MEME),
